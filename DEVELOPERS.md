# For Developers of ares-ollama-cloud-sbx
...
```shell
docker build -t ares-ollama-cloud-docker-sbx:latest .
docker image save ares-ollama-cloud-docker-sbx:latest -o ares-ollama-cloud-docker-sbx.tar
sbx template load ares-ollama-cloud-docker-sbx.tar

...
A custom [Docker Sandbox](https://docs.docker.com/ai/sandboxes/) template that securely and easily runs [Ares](https://github.com/clout2buy/Ares) with [Ollama Cloud](https://ollama.com) as the LLM provider.
